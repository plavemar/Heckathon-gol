...
public class InitService implements CommandLineRunner {
    ...
    static {
        ...
        oscilators.put(0, "0000000000000000000000");
        oscilators.put(1, "0000001110000000000000");
        oscilators.put(2, "0111011100000000000000");
        oscilators.put(3, "0000000000000000000000");
        oscilators.put(4, "1100000000000000111000");
        oscilators.put(5, "1100000000000000101000");
        oscilators.put(6, "0011000000000000111000");
        oscilators.put(7, "0011000000000000111000");
        oscilators.put(8, "0000000000000000111000");
        oscilators.put(9, "0000000000000000111000");
        oscilators.put(10, "0000000000000000101000");
        oscilators.put(11, "0000000000000000111000");
        oscilators.put(12, "0000000000000000000000");
        oscilators.put(13, "0000000000000000000000");
        oscilators.put(14, "0000000000000000000000");
        oscilators.put(15, "0000000000000000000000");
